...
namespace Obliga_API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PeopleController : ControllerBase
    {
        private readonly Obliga_APIContext _context;

        public PeopleController(Obliga_APIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<People>> PostPeople(People people)
        {
          if (_context.People == null)
          {
              return Problem("Entity set 'Obliga_APIContext.People'  is null.");
          }
